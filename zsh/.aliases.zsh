...
# Cybersecurity
alias nmap='nmap -v -A'
alias masscan='masscan -p1-65535'
alias wfuzz='wfuzz -c'  
alias gobuster='gobuster dir -w /usr/share/wordlists/dirb/common.txt -t 50'
alias hydra='hydra -t 64'
alias sqlmap='sqlmap -v 3 --batch'